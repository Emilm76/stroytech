          ...
          <div className={styles.grid}>
            <div className={styles.blueItem}>
              ...
              <p>
                ...
                в структуре компании и освоить базовые инструменты. Уже с первых
                дней вы чувствуете уверенность и начинаете приносить результат.
              </p>
            </div>
            <div className={styles.blueItem}>
              <h3 className="h3">
              ...
              <p>
                ...
                <br />
                Каждый курс «Стройтеха» - это реальные кейсы, тесты и поддержка
                кураторов, чтобы знания превращались в результат.
              </p>
            </div>
            <div className={styles.blueItem}>
              <h3 className="h3">
